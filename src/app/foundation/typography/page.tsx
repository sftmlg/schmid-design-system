					...
					<div className='space-y-6'>
						<div className='space-y-2'>
							<p className='text-xl'>
								...
								This text demonstrates the base reading experience for large body
								content.
							</p>
							<p className='text-sm text-muted-foreground'>
								text-xl · 20px · 400 · 1.7
							</p>
						</div>
						<div className='space-y-2'>
							<p className='text-lg'>
								Body Large - The quick brown fox jumps over the lazy dog. This
								text demonstrates the base reading experience for emphasized body
								content.
							</p>
							<p className='text-sm text-muted-foreground'>
						...
						<div className='space-y-2'>
							<p className='text-base'>
								Body - The quick brown fox jumps over the lazy dog. This text
								demonstrates the base reading experience for standard body
						...
						<div className='space-y-2'>
							<p className='text-sm'>
								Body Small - The quick brown fox jumps over the lazy dog. This
								text is used for supporting information and secondary content.
							</p>
							<p className='text-sm text-muted-foreground'>
						...
						<div className='space-y-2'>
							<p className='text-xs'>
								...
								This text is used for captions and labels.
							</p>
							<p className='text-sm text-muted-foreground'>
