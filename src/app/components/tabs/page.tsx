				...
				<ComponentPreview>
					<Tabs defaultValue='tab1' className='w-full'>
						...
						<TabsContent value='tab1'>
							<div className='rounded-md border p-4'>
								<p className='text-sm text-muted-foreground'>
									Account settings and preferences. Manage your profile
						...
						<TabsContent value='tab2'>
							<div className='rounded-md border p-4'>
								<p className='text-sm text-muted-foreground'>
									Change your password and security settings. Keep your account
									secure.
								</p>
							</div>
						</TabsContent>
						<TabsContent value='tab3'>
							<div className='rounded-md border p-4'>
								<p className='text-sm text-muted-foreground'>
									Configure application settings and preferences. Customize your
									experience.
								</p>
							</div>
						</TabsContent>
					...
					<Tabs defaultValue='description' className='w-full'>
						...
						<TabsContent value='reviews' className='space-y-4'>
							<div className='rounded-md border p-4'>
								...
								<p className='text-sm text-muted-foreground'>
									Great product! Exactly what I was looking for. Highly
									recommend.
								</p>
							</div>
							<div className='rounded-md border p-4'>
								...
								<p className='text-sm text-muted-foreground'>
									Excellent quality and fast shipping. Very satisfied with my
									purchase.
								</p>
							</div>
						</TabsContent>
			...
			<Section id='accessibility' title='Accessibility'>
				<ComponentPreview>
					<div className='space-y-4'>
						<p className='text-sm text-muted-foreground'>
							The Tabs component is fully accessible and follows WAI-ARIA
							patterns:
						</p>
						<ul className='list-disc list-inside text-sm text-muted-foreground space-y-1'>
							<li>
